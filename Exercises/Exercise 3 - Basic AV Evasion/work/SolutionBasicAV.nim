...
# Présentation d'une méthode avec evasion, permet de bypasser un certain nombre d'antivirus

# Fonction utilitaire pour faire un xor du shellcode -> obfuscation
...
when defined(windows):
    # On déclare le shellcode chiffré, output obtenu grâce à SolutionEncrypt.nim
